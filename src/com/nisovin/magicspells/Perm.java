...
public enum Perm {
	...
	MODIFY_VARIABLE("magicspells.advanced.modifyvariable"),
	MODIFY_MANA(null, true),
	SET_MAX_MANA(null, true),
	UPDATE_MANA_RANK(null, true),
	RESET_MANA(null, true),
	SET_MANA(null, true),
	MAGICITEM("magicspells.advanced.magicitem"),
	DOWNLOAD(null, true),
	UPDATE(null, true),
	SAVESKIN(null, true),
	PROFILE(null, true),
	DEBUG("magicspells.advanced.debug"),
	FORCECAST("magicspells.advanced.forcecast"),
	RELOAD("magicspells.advanced.reload"),
	RESET_COOLDOWN("magicspells.advanced.resetcd"),
	CAST_AT("magicspells.advanced.castat"),
